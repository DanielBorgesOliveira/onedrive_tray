...
TRANSLATIONS += onedrive_tray_en.ts onedrive_tray_fr.ts onedrive_tray_es.ts onedrive_tray_nl.ts onedrive_tray_it.ts onedrive_tray_de.ts onedrive_tray_cs.ts
